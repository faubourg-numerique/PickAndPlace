...
class DobotController(Node):
    def __init__(self):
        ...
        self.create_subscription(Float64, '/target_r', self.orientation_callback, 10)

        # Subscribe to gripper topic
        self.create_subscription(String, '/gripper', self.gripper_callback, 10)
        # Client pour appeler le service du gripper
    ...
    def gripper_callback(self, msg):
        ...
        self.get_logger().info(f'Received gripper state: {gripper_state}')

        # Appel du service pour contrôler le gripper
